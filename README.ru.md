...
| [`plugin/`](plugin/README.ru.md) | Gradle-плагин `Component Initializer Injector` — патчинг байткода: автоматически встраивает вызовы инициалайзеров в публичные методы классов на этапе сборки. |

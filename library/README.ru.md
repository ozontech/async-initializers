...
[English](../library/README.md) | **Русский**
...
### Расширение возможностей с помощью async-initializer-Injector plugin

Плагин async-initializer-Injector предоставляет дополнительное решение для вставки вызовов вида
...
Для ознакомления и подключения используйте специальный плагин [async-initializer-Injector](../plugin/README.ru.md).

...
### Расширение возможностей с помощью asyncInitializer-injector plugin

Плагин asyncInitializer-injector предоставляет дополнительное решение для вставки вызовов вида
...
Для ознакомления и подключения используйте специальный плагин [asyncInitializer-injector](../plugin/README.ru.md).
